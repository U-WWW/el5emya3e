...
const regexShell = /return \(\s*<div className="min-h-screen text-stone-100">[\s\S]*?\{" "\/\* Main Container Layout \*\/" "\}\s*<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8 lg:pr-\[18rem\]">/;
          ...
          <div className="flex items-center justify-between h-20 md:h-24">
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col">
                <span className="font-black text-xl md:text-2xl tracking-widest text-amber-500 uppercase">
                  Al-Menshawy
                </span>
...
// More robust regex
code = code.replace(/return \(\s*<div className="min-h-screen text-stone-100">[\s\S]*?\{\/\* Main Container Layout \*\/\}[\s\S]*?<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8 lg:pr-\[18rem\]">/, newNavReplacement);
